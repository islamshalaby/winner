...
<div class="col-lg-12 col-12 layout-spacing">
        ...
        <div class="widget-header">
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>{{ __('messages.competition_terms') }}</h4>
             </div>
        </div>
        @if (session('status'))
        ...
        <form class="texteditorForm" action="" method="post" >
                ...
                <div class="form-group mb-4 arabic-direction">
                    ...
                    <textarea id="editor-ck-ar" name="competition_terms" required  class="form-control"  rows="5">{{ $data['setting']['competition_terms'] }}</textarea>
                </div>                
